  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        {/* Left Column: Form */}
        <div className="lg:col-span-7 bg-white dark:bg-slate-900/90 rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-white/10 shadow-card dark:shadow-card-dark space-y-6 backdrop-blur-md">
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            
            {/* Section 1: Package & Theme Selection */}
            <div className="space-y-4">
              <h3 className="text-sm font-black text-party-purple-700 dark:text-party-purple-400 uppercase tracking-wider flex items-center gap-2 pb-2 border-b border-slate-100 dark:border-white/10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm font-semibold text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                      errors.package ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                    }`}
                  >
                    {packages.map((pkg) => (
                      <option key={pkg.id} value={pkg.id} className="dark:bg-slate-900 text-slate-900 dark:text-white">
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm font-semibold text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                      errors.theme ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                    }`}
                  >
                    {themes.map((theme) => (
                      <option key={theme.id} value={theme.id} className="dark:bg-slate-900 text-slate-900 dark:text-white">
                        {theme.name}
                      </option>
                    ))}
                  </select>
            ...
            <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-white/10">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                        errors.birthdayPersonName ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                      }`}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                        errors.guests ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                      }`}
                    />
                  </div>
              ...
              <div>
                <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1.5">
                  Event Date <span className="text-rose-500">*</span> <span className="text-slate-400 font-normal">(Past dates disabled)</span>
                </label>
                <input
                  type="date"
                  min={todayStr}
                  ...
                  className={`w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm text-slate-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                    errors.eventDate ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                  }`}
                />
            ...
            <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-white/10">
              <div className="flex items-center justify-between pb-2 border-b border-slate-100 dark:border-white/10">
                <h3 className="text-sm font-black text-party-purple-700 dark:text-party-purple-400 uppercase tracking-wider flex items-center gap-2">
                  ...
                  3. Party Add-ons & Extras <span className="text-slate-400 font-normal text-xs uppercase font-sans">(Optional)</span>
                </h3>
                    ...
                    <div
                      ...
                      className={`cursor-pointer rounded-2xl p-3.5 border transition-all duration-200 flex items-start gap-3 relative ${
                        isSelected 
                          ...
                          : 'border-slate-200 dark:border-slate-800 hover:border-party-purple-300 dark:hover:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800/40'
                      }`}
                    >
                      <div className={`p-2 rounded-xl shrink-0 ${isSelected ? 'bg-party-purple-600 dark:bg-party-pink-600 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300'}`}>
                        {getAddonIcon(addon.icon)}
                      </div>
                      <div className="flex-1 pr-6">
                        <div className="flex items-center justify-between">
                          <h4 className="text-xs font-bold text-slate-900 dark:text-white">{addon.name}</h4>
                        </div>
                        <p className="text-[11px] text-slate-500 dark:text-slate-400 mt-0.5 leading-snug">{addon.description}</p>
                        <span className="inline-block mt-2 text-xs font-extrabold text-party-purple-700 dark:text-party-pink-300 bg-white dark:bg-slate-800 px-2 py-0.5 rounded-md border border-slate-200 dark:border-slate-700 shadow-2xs">
                          +€{addon.price}
                        </span>
                      </div>
                      <div className="absolute top-3.5 right-3.5">
                        <div className={`w-5 h-5 rounded-full flex items-center justify-center transition-all ${
                          isSelected ? 'bg-party-purple-600 dark:bg-party-pink-500 text-white' : 'border border-slate-300 dark:border-slate-700 text-transparent'
                        }`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                      errors.customerName ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                      errors.email ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                    }`}
                  />
                ...
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-party-purple-500 ${
                      errors.phone ? 'border-rose-400 bg-rose-50/30' : 'border-slate-200 dark:border-slate-800'
                    }`}
                  />
            ...
            <div className="space-y-3 pt-4 border-t border-slate-100 dark:border-white/10">
              <h3 className="text-sm font-black text-party-purple-700 dark:text-party-purple-400 uppercase tracking-wider flex items-center gap-2 pb-1">
                ...
                5. Promo Code & Discount <span className="text-slate-400 font-normal text-xs uppercase font-sans">(Optional)</span>
              </h3>
              ...
              {!appliedPromo ? (
                  ...
                  <div className="flex gap-2">
                    <div className="relative flex-1">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 text-sm font-mono text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-party-purple-500 uppercase"
                      />
                    </div>
                    <button
                      type="button"
                ...
                <div className="bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 p-3.5 rounded-2xl flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1.5 text-emerald-700 dark:text-emerald-300 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
            ...
            <div className="space-y-3 pt-4 border-t border-slate-100 dark:border-white/10">
              <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 mb-1">
                Special Requirements & Notes <span className="text-slate-400 font-normal">(Optional)</span>
              </label>
              <textarea
                rows={3}
                ...
                className="w-full px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800 text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-party-purple-500"
              ></textarea>
            </div>
        ...
        <div className="lg:col-span-5 sticky top-24 space-y-6">
          <div className="bg-white dark:bg-slate-900/90 rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-white/10 shadow-card dark:shadow-card-dark space-y-6 backdrop-blur-md">
            ...
            {activePackage && (
              <div className="space-y-3">
                <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-950/60 p-3 rounded-2xl border border-slate-200/60 dark:border-white/10">
                  <img
                  ...
                  <div>
                    ...
                    <h4 className="font-extrabold text-slate-900 dark:text-white text-sm">{activePackage.name}</h4>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Up to {activePackage.max_guests} guests</p>
                  </div>
                </div>
            ...
            {activeTheme && (
              <div className="flex items-center gap-3 bg-slate-50 dark:bg-slate-950/60 p-3 rounded-2xl border border-slate-200/60 dark:border-white/10">
                ...
                <div>
                  ...
                  <h4 className="font-extrabold text-slate-900 dark:text-white text-xs">{activeTheme.name}</h4>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400">{activeTheme.tag}</p>
                </div>
              </div>
            )}
              ...
              <div className="space-y-2 pt-3 border-t border-slate-100 dark:border-white/10">
                ...
                <div className="space-y-1 text-xs">
                  {selectedAddonIds.map(id => {
                    ...
                    return (
                      <div key={id} className="flex items-center justify-between text-slate-700 dark:text-slate-300 bg-slate-50 dark:bg-slate-950/60 px-2.5 py-1.5 rounded-lg border border-slate-200/60 dark:border-white/10">
            ...
            <div className="space-y-2.5 pt-4 border-t border-slate-100 dark:border-white/10 text-xs">
              <div className="flex justify-between text-slate-600 dark:text-slate-400">
                <span>Birthday Person:</span>
                <span className="font-bold text-slate-800 dark:text-slate-200">{birthdayPersonName || 'Not specified'}</span>
              </div>
              <div className="flex justify-between text-slate-600 dark:text-slate-400">
                <span>Event Date:</span>
                <span className="font-bold text-slate-800 dark:text-slate-200">{eventDate || 'Not selected'}</span>
              </div>
              <div className="flex justify-between text-slate-600 dark:text-slate-400">
                <span>Guests Count:</span>
                <span className="font-bold text-slate-800 dark:text-slate-200">{guests} guests</span>
              </div>
              
              <div className="pt-2 border-t border-slate-100 dark:border-white/10 space-y-1.5">
                <div className="flex justify-between text-slate-600 dark:text-slate-400">
                  <span>Base Package:</span>
                  <span className="font-bold text-slate-800 dark:text-slate-200">€{basePrice}</span>
                </div>
                {addonsTotal > 0 && (
                  <div className="flex justify-between text-slate-600 dark:text-slate-400">
                    <span>Add-ons Total:</span>
                    <span className="font-bold text-slate-800 dark:text-slate-200">+€{addonsTotal}</span>
                  </div>
                )}
                {discountAmount > 0 && (
            ...
            <div className="pt-4 border-t border-slate-200 dark:border-slate-800 bg-party-purple-50/70 dark:bg-slate-950/80 -mx-6 -mb-6 p-6 rounded-b-3xl flex items-center justify-between">
              <div>
                <span className="text-xs text-slate-500 dark:text-slate-400 font-semibold block">Estimated Price</span>
                {discountAmount > 0 ? (
              ...
              <div className="text-right">
                {discountAmount > 0 && (
                  <span className="text-xs text-slate-400 line-through block font-semibold">€{subtotal}</span>
                )}
          ...
          {/* Guarantee Pill */}
          <div className="bg-white dark:bg-slate-900/90 rounded-2xl p-4 border border-slate-200/80 dark:border-white/10 flex items-center gap-3 text-xs text-slate-600 dark:text-slate-300 shadow-sm backdrop-blur-md">
            <ShieldCheck className="w-6 h-6 text-party-purple-600 dark:text-party-purple-400 shrink-0" />
            <p>
              <strong className="text-slate-800 dark:text-white font-bold">100% Satisfaction Guarantee:</strong> Easy date modifications with 48h advance notice.
            </p>
          </div>
